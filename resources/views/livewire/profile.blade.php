<div class="h-full w-full">
    <div class="font-medium w-full h-full flex-col sm:flex-col md:flex-row gap-4 lg:gap-8 lg:px-4 px-2">
            <div class="p-8 flex items-center justify-center h-[50vh] text-gray-600 w-full  border-gray-100 bg-darkGreen rounded-2xl ">
              <!-- Component Start -->
              <div class="h-full flex flex-col  max-w-full w-full  pe-0">
                  <div class="h-full flex flex-row items-center text-white align-middle text-center justify-center">
