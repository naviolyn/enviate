    ...
    <div class="bg-white p-8 rounded-xl border border-gray-200">
        ...
        <form wire:submit.prevent="update">
            ...
            <div class="mb-4">
                ...
                <input type="email" wire:model="email" id="email" class="mt-1 bg-white border border-gray-200 text-sm rounded-lg focus:ring-darkGreen focus:border-darkGreen block w-full p-2.5 focus:bg-lightGreen">
