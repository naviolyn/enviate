<div class="h-full overflow-hidden">
    ...
    <div class="flex items-center justify-center font-medium w-full h-full bg-white ">
        
        <div class="flex w-full items-center justify-center h-full text-gray-600 bg-white">
            <!-- Component Start -->
            <div class="flex flex-col  max-w-full ps-8 w-full h-full pe-0">
                <div class="flex items-center mb-6">
                    ...
                    <h4 class="font-semibold ml-3 text-lg">Today task</h4>
                </div>
                <div class="overflow-y-auto h-full">
                    <div>
                        ...
                        <div class="flex w-full justify-between hover:bg-gray-100 rounded-md px-2">
                            ...
                            <label class="flex items-center h-10 rounded cursor-pointer " for="task_2">
                                <span class="flex items-center justify-center w-5 h-5 text-transparent border-2 border-gray-300 rounded-full">
                                    <svg class="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                                    </svg>
