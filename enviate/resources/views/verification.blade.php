...
<section class="bg-white h-full">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 h-full">
        <div class="mx-auto max-w-screen-md sm:text-center text-center items-center h-full align-middle flex flex-col justify-center">
            ...
            <p class="mx-auto mb-8 max-w-2xl font-light text-gray-500 md:mb-12 sm:text-xl">SThanks for signing up! Before getting started, could you verify your email address clicking on the link we just emailed to you? If you didn't receive the email, we will gladly send you another.</p>
            <form action="#">
